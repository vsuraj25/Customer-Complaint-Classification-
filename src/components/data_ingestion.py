...
import os, sys, requests, uuid, json, re, time
import pandas as pd
...
class DataIngestion:
    ...
    def retry_download_data(self, data, download_url: DownloadUrl):
        ...
        try:
            ...
            failed_file_path = os.path.join(self.data_ingestion_config.failed_download_dir,
                                            os.path.basename(download_url.file_path))
            os.makedirs(self.data_ingestion_config.failed_download_dir, exist_ok=True)
